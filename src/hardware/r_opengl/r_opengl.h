...
// On Android the engine renders desktop-style GL through gl4es (-> GLES2).
// SDL's SDL_opengl.h pulls <windows.h> on this build, and the NDK has no
// <GL/gl.h>; use the gl4es desktop-GL emulation headers instead (the gl4es
// include dir is placed ahead of include/SDL2 in CMakeLists.txt).
