...
#ifdef __ANDROID__
// Tegra 3 software renderer: cap draw distance by default (Infinite hammers the
// rasterizer in busy scenes). Still user-overridable in the menu/config.
consvar_t cv_drawdist = {"drawdist", "2048", CV_SAVE, drawdist_cons_t, NULL, 0, NULL, NULL, 0, 0, NULL};
#else
